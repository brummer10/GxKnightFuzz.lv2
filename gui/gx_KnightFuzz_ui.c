...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_KnightFuzzUI* ui = (gx_KnightFuzzUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxKnightFuzz" ;
    ...
    set_expose_func(GX_KNIGHTFUZZ_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->label[1] = gtk_label_new("VOLUME");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)VOLUME;
